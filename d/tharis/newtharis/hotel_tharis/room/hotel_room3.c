...
void create(){
	...
	set_door_description("ebony door","%^RESET%^Fashioned from %^BOLD%^%^BLACK%^solid ebony%^RESET%^, this door is massive and sturdy in construction. The door is adorned with a %^BOLD%^%^BLACK%^s%^RESET%^i%^BOLD%^l%^RESET%^v%^BOLD%^%^BLACK%^er l%^RESET%^o%^BOLD%^c%^BLACK%^ks%^RESET%^e%^BOLD%^%^BLACK%^t%^RESET%^.");
