...
void create()
{
    ...
    set_lore(CRAYON_D->color_string("Not long ago, during the re-awakening of the great and ancient primordials, a shard broke from the primordial of light, Edea and plummeted to the ground. As the shard fell, Ashra, the primordial of darkness, split the shard and corrupted one of the halves. The two shards became the gods Seija and Khyron. While Khyron wrought the influence of chaos and destruction upon the world, Seija sought to assert balance upon nature, and began to put plans into motion to offset the great evil she saw spreading in the world. To that end, a great and powerful hammer was created, infused with the fertile power of nature. This hammer has been set upon the world, awaiting a champion worthy of wielding its verdant power. This champion, who will be known as the Verdant Champion, will once more return balance to nature and protect the wilds of the world.", "light green")); 
}
