...
void create() 
{
    ...
    feat_desc("Improved Resistance is a passive feat that when taken will further boost a character's saves by +1 and grant an additional +9 spell damage resistance.");
    permanent(1);
